...
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:81',
    'http://127.0.0.1:81',  # Optional but often needed
]
...
AUTHENTICATION_BACKENDS = [
    'accounts.authentication.CustomAuthBackend',  # custom authenticator using email instead username !!!
    'django.contrib.auth.backends.ModelBackend',  # authenticate from dj using username
]
...
CSRF_COOKIE_HTTPONLY = True  # cant get it with document.cookie
